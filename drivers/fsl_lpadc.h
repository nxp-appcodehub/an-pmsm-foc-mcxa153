...
#endif                                                   /* ADC_STAT_FOF1_MASK */

#if defined(ADC_STAT_RDY1_MASK)
...
#endif                                                              /* ADC_IE_FOFIE1_MASK */

#if defined(ADC_IE_FWMIE1_MASK)
...
#endif                                                         /* ADC_IE_FWMIE1_MASK */

#if defined(ADC_IE_TEXC_IE_MASK)
    kLPADC_TriggerExceptionInterruptEnable = ADC_IE_TEXC_IE_MASK, /*!< Configures ADC to generate trigger exception
                                                                      interrupt. */
#endif                                                            /* ADC_IE_TEXC_IE_MASK */

#if (defined(ADC_IE_TCOMP_IE_MASK) && (ADC_IE_TCOMP_IE_MASK >= 0xF0000U))
...
#endif                                                                      /* ADC_IE_TCOMP_IE_MASK >= 0xF0000U */

#if (defined(ADC_IE_TCOMP_IE_MASK) && (ADC_IE_TCOMP_IE_MASK >= 0xFF0000U))
...
#endif                                                                      /* (ADC_IE_TCOMP_IE_MASK >= 0xFF0000U) */

#if (defined(ADC_IE_TCOMP_IE_MASK) && (ADC_IE_TCOMP_IE_MASK >= 0xFFF0000U))
...
#endif                                                                        /* (ADC_IE_TCOMP_IE_MASK >= 0xFFF0000U) */

#if (defined(ADC_IE_TCOMP_IE_MASK) && (ADC_IE_TCOMP_IE_MASK == 0xFFFF0000U))
...
#endif /* (ADC_IE_TCOMP_IE_MASK == 0xFFFF0000U) */
};
...
{
#if (defined(ADC_TSTAT_TEXC_NUM_MASK) && (ADC_TSTAT_TEXC_NUM_MASK >= 0xFU))
...
#endif                                           /* ADC_TSTAT_TEXC_NUM_MASK >= 0xFU */

#if (defined(ADC_TSTAT_TEXC_NUM_MASK) && (ADC_TSTAT_TEXC_NUM_MASK >= 0xFFU))
...
#endif                                           /* ADC_TSTAT_TEXC_NUM_MASK >= 0xFFU */

#if (defined(ADC_TSTAT_TEXC_NUM_MASK) && (ADC_TSTAT_TEXC_NUM_MASK >= 0xFFFU))
...
#endif                                             /* ADC_TSTAT_TEXC_NUM_MASK >= 0xFFFU */

#if (defined(ADC_TSTAT_TEXC_NUM_MASK) && (ADC_TSTAT_TEXC_NUM_MASK == 0xFFFFU))
...
#endif                                             /* ADC_TSTAT_TEXC_NUM_MASK >= 0xFFFFU */

#if (defined(ADC_TSTAT_TCOMP_FLAG_MASK) && (ADC_TSTAT_TCOMP_FLAG_MASK >= 0xF0000U))
...
#endif                                          /* ADC_TSTAT_TCOMP_FLAG_MASK >= 0xF0000U */

#if (defined(ADC_TSTAT_TCOMP_FLAG_MASK) && (ADC_TSTAT_TCOMP_FLAG_MASK >= 0xFF0000U))
...
#endif                                          /* ADC_TSTAT_TCOMP_FLAG_MASK >= 0xFF0000U */

#if (defined(ADC_TSTAT_TCOMP_FLAG_MASK) && (ADC_TSTAT_TCOMP_FLAG_MASK >= 0xFFF0000U))
...
#endif                                           /* ADC_TSTAT_TCOMP_FLAG_MASK >= 0xFFF0000U */

#if (defined(ADC_TSTAT_TCOMP_FLAG_MASK) && (ADC_TSTAT_TCOMP_FLAG_MASK == 0xFFFF0000U))
...
#endif                                           /* ADC_TSTAT_TCOMP_FLAG_MASK == 0xFFFF0000U */
};
...
typedef enum _lpadc_sample_channel_mode
{
    ...
    kLPADC_SampleChannelDiffBothSideAB = 0x2U, /*!< Differential mode, A-side channel is plus side, B-side channel
                                                  is minus side, A-B. */
    kLPADC_SampleChannelDiffBothSideBA = 0x3U, /*!< Differential mode, B-side channel is plus side, A-side channel
                                                  is minus side, B-A. @note Only available when VERID[bit11] = 0.  */
    kLPADC_SampleChannelDualSingleEndBothSide =
        0x83U, /* Dual-Single-Ended Mode. Both A side and B side channels are
            converted independently. @note Only available when VREID[bit11] = 1. */
    kLPADC_SampleChannelDiffBothSide = kLPADC_SampleChannelDiffBothSideAB, /*!< Legacy, do not recommend using. */
...
#if (defined(ADC_CMDH_AVGS_MASK) && (ADC_CMDH_AVGS_MASK == 0xF000U))
...
#endif                                     /* ADC_CMDH_AVGS_MASK == 0xF000U */
...
#if (defined(ADC_CTRL_CAL_AVGS_MASK) && (ADC_CTRL_CAL_AVGS_MASK == 0xF0000U))
...
#endif                                  /* ADC_CTRL_CAL_AVGS_MASK == 0xF0000U */
...
typedef enum _lpadc_trigger_priority_policy
{
    ...
    kLPADC_ConvPreemptSoftlyAutoRestarted = 0x5U,      /*!< If a higher priority trigger is received during command
                                                       ...
                                                       automatically be restarted. */
#endif                                                 /* defined(ADC_CFG_TRES_MASK) */
#if defined(ADC_CFG_TCMDRES_MASK)
...
#endif                                               /* defined(ADC_CFG_TCMDRES_MASK) */
...
#if (defined(ADC_CFG_TPRICTRL_MASK) && (ADC_CFG_TPRICTRL_MASK == 0x3U))
    ...
    kLPADC_TriggerPriorityPreemptSubsequently =
        kLPADC_ConvPreemptSubsequentlyNotAutoResumed, /*!< Legacy support is not recommended as it only ensures
                                                         compatibility with older versions. */
#endif /* (defined(ADC_CFG_TPRICTRL_MASK) && (ADC_CFG_TPRICTRL_MASK == 0x3U)) */

#if defined(ADC_CFG_HPT_EXDI_MASK)
    kLPADC_TriggerPriorityExceptionDisabled = 0x80U, /*!<  High priority trigger exception disabled. */
#endif                                               /* defined(ADC_CFG_HPT_EXDI_MASK) */
...
#if defined(FSL_FEATURE_LPADC_HAS_CTRL_CALOFS) && FSL_FEATURE_LPADC_HAS_CTRL_CALOFS
#if defined(FSL_FEATURE_LPADC_HAS_OFSTRIM) && FSL_FEATURE_LPADC_HAS_OFSTRIM
#if defined(ADC_OFSTRIM_OFSTRIM_MASK)
/*!
...
static inline void LPADC_GetOffsetValue(ADC_Type *base, int16_t *pValue)
{
    ...
    *pValue = (int16_t)((base->OFSTRIM & (ADC_OFSTRIM_OFSTRIM_MASK)) >> ADC_OFSTRIM_OFSTRIM_SHIFT);
}
#elif (defined(ADC_OFSTRIM_OFSTRIM_A_MASK) && defined(ADC_OFSTRIM_OFSTRIM_B_MASK))
/*!
 * @brief Set proper offset value to trim ADC.
 *
...
static inline void LPADC_GetOffsetValue(ADC_Type *base, int32_t *pValueA, int32_t *pValueB)
{
    ...
    *pValueA = ((base->OFSTRIM & ADC_OFSTRIM_OFSTRIM_A_MASK) >> ADC_OFSTRIM_OFSTRIM_A_SHIFT);
    *pValueB = ((base->OFSTRIM & ADC_OFSTRIM_OFSTRIM_B_MASK) >> ADC_OFSTRIM_OFSTRIM_B_SHIFT);
}
#endif /* defined(ADC_OFSTRIM_OFSTRIM_MASK) */
