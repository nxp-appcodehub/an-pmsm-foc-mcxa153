...
WEAK void OSTimer0_IRQHandler(void);
...
void OSTimer0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    OSTimer0_IRQHandler,               // 73: OS event timer interrupt
