...
typedef struct _mcdrv_qd_enc_t
{
    ...
    frac32_t    *pf32SpdMeEst;        /* pointer to measured mechanical speed  */
    ...
    frac32_t    f32SpdMeEst;          /* estimated speed calculated using tracking observer */
    ...
    frac32_t    f32SpdEncMin;         /* encoder minimal speed resolution */
