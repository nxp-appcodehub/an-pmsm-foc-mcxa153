...
void MCDRV_QdEncGet(mcdrv_qd_enc_t *this)
{
    ...
    this->f16PosMeEst = (frac16_t)AMCLIB_TrackObsrv_F16(this->a32PosErr, &this->sTo);
    ...
    this->f32SpdMeEst = this->sTo.f32Speed;
    ...
    if ((MLIB_Abs_F32(this->f32SpdMeEst) < (this->f32SpdEncMin)))
    {
        this->f32SpdMeEst = 0U;
    }
    ...
    *this->pf32SpdMeEst = (this->f32SpdMeEst);
