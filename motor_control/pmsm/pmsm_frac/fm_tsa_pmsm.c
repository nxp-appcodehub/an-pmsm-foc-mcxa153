...
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sUDQEst.f16D, FMSTR_TSA_FRAC16) /* Ud est */
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sUDQEst.f16Q, FMSTR_TSA_FRAC16) /* Uq est */
...
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sBemfObsrv.f16Error, FMSTR_TSA_FRAC16)
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sBemfObsrv.sEObsrv.f32D, FMSTR_TSA_FRAC32)
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sBemfObsrv.sEObsrv.f32Q, FMSTR_TSA_FRAC32)
...
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sTo.f32Speed, FMSTR_TSA_FRAC32)
...
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.bCurrentLoopOn, FMSTR_TSA_UINT16)
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.bOpenLoop, FMSTR_TSA_UINT16)
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.bPosExtOn, FMSTR_TSA_UINT16)
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.f16SpeedElEst, FMSTR_TSA_FRAC16)
...
FMSTR_TSA_RW_VAR(g_sM1Drive.sScalarCtrl.i16VHzGainShift, FMSTR_TSA_SINT16)
...
FMSTR_TSA_RW_VAR(g_sM1Drive.f16BemfUqAvg, FMSTR_TSA_FRAC16) /* MCAT Uq Required */

FMSTR_TSA_RW_VAR(g_sM1Drive.ui16BlockRotorCnt, FMSTR_TSA_UINT16)
...
FMSTR_TSA_RO_MEM(g_sAppIdFM.cMotorType, FMSTR_TSA_UINT8, &g_sAppIdFM.cMotorType[0], 30)
...
/* cycle number (CPU load) measurement */
